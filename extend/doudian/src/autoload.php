...
class autoload
{
	...
	public static function loadClass($class)
	{
		...
		$filename = $rootPath."/open/api/product_queryPropAutoOptimizeConfig/".$class.".php";
		if(is_file($filename)) {
			include $filename;
			return;
		}
		$filename = $rootPath."/open/api/product_queryPropAutoOptimizeConfig/param/".$class.".php";
		if(is_file($filename)) {
			include $filename;
			return;
		}
		...
		$filename = $rootPath."/open/api/product_openPropAutoOptimize/".$class.".php";
		if(is_file($filename)) {
			include $filename;
			return;
		}
		$filename = $rootPath."/open/api/product_openPropAutoOptimize/param/".$class.".php";
		if(is_file($filename)) {
			include $filename;
			return;
		}
